...
// Define interface IIDs to avoid link errors on some SDKs
extern "C" const IID IID_IAudioProcessingObject =
{ 0xFD7F2B29, 0x24D0, 0x4B5C, { 0xB1, 0x77, 0x59, 0x2C, 0x39, 0xF9, 0xCA, 0x10 } };
extern "C" const IID IID_IAudioProcessingObjectRT =
{ 0x9E1D6A6D, 0xDDBC, 0x4E95, { 0xA4, 0xC7, 0xAD, 0x64, 0xBA, 0x37, 0x84, 0x6C } };
extern "C" const IID IID_IAudioProcessingObjectConfiguration =
